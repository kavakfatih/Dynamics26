...
| M6-NUM-004 | H. Bronnimann, C. Burnikel, S. Pion, *Interval Arithmetic Yields Efficient Dynamic Filters for Computational Geometry*, Discrete Applied Mathematics 109(1-2), 2001 | Dynamic interval filters for exact geometric sign decisions; runtime interval enclosure and exact fallback architecture | https://doi.org/10.1016/S0166-218X(00)00231-6 | 2026-09-06 |
| M6-NUM-005 | G. Melquiond, S. Pion, *Formally Certified Floating-Point Filters for Homogeneous Geometric Predicates*, RAIRO TIA 41(1), 2007 | Formal/semi-static filter certification; evidence that range/rounding details create subtle hand-proof pitfalls | https://doi.org/10.1051/ita:2007005 | 2026-09-06 |
| M6-NUM-006 | N. J. Higham, *Accuracy and Stability of Numerical Algorithms*, 2nd ed., Chapter 3, SIAM, 2002 | Standard unit-roundoff and gamma_n framework for accumulated floating-point error analysis | https://doi.org/10.1137/1.9780898718027.ch3 | 2026-09-06 |


| M6-NUM-007 | IEEE Std 1788.1-2017, *IEEE Standard for Interval Arithmetic (Simplified)* | Active binary64 interval-arithmetic model and containment-oriented operation semantics | https://standards.ieee.org/ieee/1788.1/6074/ | 2026-09-06 |
| M6-NUM-008 | Clang Compiler User's Manual, *Controlling Floating Point Behavior* | Round-mode assumptions, strict/precise/fast models, FENV access, FP contraction, reassociation and denormal controls | https://clang.llvm.org/docs/UsersManual.html#controlling-floating-point-behavior | 2026-09-06 |
| M6-NUM-009 | Apple, *Mac OS X Manual Page for nextafter(3)* | Apple-platform reference that nextafter returns the next machine-representable number in the requested direction | https://developer.apple.com/library/archive/documentation/System/Conceptual/ManPages_iPhoneOS/man3/nextafterf.3.html | 2026-09-06 |
